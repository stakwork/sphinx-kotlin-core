...
internal class PathAdapter private constructor(): ColumnAdapter<Path, String> {

    companion object {
        @Volatile
        private var instance: PathAdapter? = null
        fun getInstance(): PathAdapter =
            instance ?: synchronized(this) {
                instance ?: PathAdapter()
                    .also { instance = it }
            }
    }
