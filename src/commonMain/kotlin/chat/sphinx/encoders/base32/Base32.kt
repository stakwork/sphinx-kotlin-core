...
* */
package chat.sphinx.encoders.base32
...
sealed class Base32 {
    ...
    object Crockford: Base32() {
        override val encodingTable: ByteArray =
            "0123456789ABCDEFGHJKMNPQRSTVWXYZ".toByteArray(Charsets.UTF_8)
    }

    object Default: Base32() {
        override val encodingTable: ByteArray =
            "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567".toByteArray(Charsets.UTF_8)
    }

    object Hex: Base32() {
        override val encodingTable: ByteArray =
            "0123456789ABCDEFGHIJKLMNOPQRSTUV".toByteArray(Charsets.UTF_8)
    }
}
